...
#ifdef EC_BIG_ENDIAN
#define EC_ETHFRM_GET_FRAMETYPE(p)          EC_GETWORD(((EC_T_BYTE*)(p)))
#define EC_ETHFRM_SET_FRAMETYPE(p, wVal)    EC_SETWORD(((EC_T_BYTE*)(p)), (wVal))
#else
#define EC_ETHFRM_GET_FRAMETYPE(p)          EC_WORDSWAP(EC_GETWORD(((EC_T_BYTE*)(p))))
#define EC_ETHFRM_SET_FRAMETYPE(p, wVal)    EC_SETWORD(((EC_T_BYTE*)(p)), EC_WORDSWAP((wVal)))
#endif
