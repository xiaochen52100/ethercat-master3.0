...
#if (!defined INCLUDE_FILE_LOGGING) && (!defined EXCLUDE_FILE_LOGGING) && (!defined RTAI)
...
#if (defined INCLUDE_FILE_LOGGING)
    static EC_T_BOOL        s_bLogFileEnb;
#endif
};
...
public:
    ...
    static CFrameLogMultiplexer G_aLogMultiplexer[MAX_NUMOF_MASTER_INSTANCES];
};
